...
**Eric Maicon** - eric@ericmaicon.com.br

**Roberto L. Machado** - linux.rlm@gmail.com (Mesmo que ele nem saiba desse projeto, toda a função de assinatura foi copiada do código que ele fez [aqui](https://www.assembla.com/code/nfephp/subversion/nodes/658/branches/2.0/libs/ToolsNFePHP.class.php)).
